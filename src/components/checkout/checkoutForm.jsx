...
function CheckoutForm(props) {
  ...
  const style = {
    parentDiv:
      "h-fit min-h-screen w-full flex flex-col gap-4 items-center justify-start sm:px-10 p-4",
    form: "flex flex-col gap-2 w-full h-fit p-2 justify-center",
    input:
      "w-full p-1 bg-white border-teal-400 border-2 hover:border-teal-600 focus:border-teal-600 rounded-md text-zinc-700 transition ease-in-out duration-300 outline-0",
    input_err:
      "w-full p-1 bg-red-50 border-red-500 border-2 hover:border-teal-600 focus:border-teal-600 rounded-md text-zinc-700 transition ease-in-out duration-300 outline-0",
  };
  //////////// rendering
  /// if payment method ready to render
  if (progress.payment && progress.info) {
    return (
      <PaymentPage
        items={items}
      ...
      <div className={style.parentDiv}>
        ...
        <div className="bg-zinc-50 h-fit w-full p-4 flex flex-row gap-6 rounded-md items-center justify-center text-sm">
          ...
          <div className="flex flex-row gap-2 items-center">
            <h2
              className={
                progress.payment == true ? "text-gray-500" : "text-green-600"
              }
            >
          ...
          <div className="flex flex-row gap-2 items-center">
            <h2
              className={
                progress.payment == false ? "text-gray-500" : "text-green-600"
              }
            >
              payment
            </h2>
