    ...
    <ApolloProvider client={client}>
      <div className="h-fit min-h-screen w-full bg-white flex flex-col ">
        ...
        <div className="w-full row-span-1 bg-gray-700 text-white flex flex-row flex-wrap gap-2 p-4 items-center justify-center">
          ...
          {/* stock */}
          <button className={style.btn} onClick={() => setPage("inventory")}>
            Inventory
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          {/* customers */}
          <button className={style.btn} onClick={() => setPage("users")}>
            Users
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          {/* content management */}
          <button className={style.btn} onClick={() => setPage("settings")}>
            Store Settings
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
